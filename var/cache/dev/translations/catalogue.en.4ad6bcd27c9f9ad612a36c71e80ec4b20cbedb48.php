...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'total.name' => 'Name (Ru)',
    'total.name_en' => 'Name',
    'total.admin_panel' => 'Admin panel',
    'total.question_about.services' => 'Questions about services',
    'total.question_about.dogs' => 'Questions about dogs',
    'total.subject' => 'Subject:',
    'total.photos' => 'Photos',
    'total.videos' => 'Videos',
    'total.log_in' => 'Login',
    'total.askquestion' => 'Ask Question',
    'total.questions' => 'Questions',
    'total.add_photo' => 'Add another photo',
    'total.add_video' => 'Add another video',
    'total.add_title' => 'Add title',
    'total.add_vaccination' => 'Add vaccination',
    'total.add_dog' => 'Add dog',
    'total.main_info' => 'Main info',
    'total.action' => 'Action',
    'total.show' => 'Show',
    'total.edit' => 'Edit',
    'total.create' => 'Create',
    ...
    'total.caption' => 'Caption',
    'total.news' => 'News',
    'total.type' => 'Category',
    'total.exhibition' => 'Exhibition',
    'total.advice' => 'Advice',
    'total.other' => 'Other',
    'total.male' => 'Male',
    'total.female' => 'Femail',
    'total.forsale' => 'Looking for a host',
    'total.select_file' => 'Select file',
    'total.uah' => 'UAH',
    'user.name' => 'User name',
    'user.phone' => 'Phone',
    'user.comment' => 'Comment',
    'user.email' => 'Email',
    'dogs.ourdogs' => 'Our Dogs',
    'dogs.title' => 'Title (RU)',
    'dogs.title_en' => 'Title',
    'dogs.vaccination' => 'Vaccination (Ru)',
    'dogs.vaccination_en' => 'Vaccination',
    'dogs.about.bdate' => 'Birthday',
    'dogs.about.name' => 'Name',
    'dogs.about.nameen' => 'Name (En)',
    'dogs.about.age' => '{0} %month% m. old|]1,Inf[ %year% y. old',
    'dogs.about.age_with_years' => '%year% y., %month% m. old',
    'dogs.about.age_without_years' => '%month% m. old',
    'dogs.about.soldout' => 'Sold out',
    'dogs.about.forsale' => 'Looking for a host',
    'dogs.about.birthday' => 'Birthday',
    'dogs.about.titles' => 'Titles',
    'dogs.about.vaccinations' => 'Vaccinations',
    'dogs.about.dogage' => 'Age',
    'dogs.about.quality' => 'Quality',
    'dogs.about.sex' => 'Sex',
    'dogs.about.state' => 'State',
    'dogs.about.quality_Show' => 'For show',
    'dogs.about.quality_Breed' => 'For breeding',
    'dogs.about.quality_Pet' => 'Pet',
    'dogs.about.description' => 'Description',
    'dogs.about.descriptionen' => 'Description (En)',
    'dogs.about.photo' => 'Photo',
    'dogs.about.photoFile' => 'Photo',
    'dogs.about.litters' => 'Litters',
    'dogs.about.otherphotos' => 'Other photos',
    'dogs.about.videos' => 'Videos',
    'dogs.about.dogsPhotos' => 'Additional photos',
    'dogs.about.dogTitles' => 'Titles',
    'dogs.about.dogVaccinations' => 'Vaccinations',
    'nursery.list.name' => 'Nursery:',
    'nursery.list.photo' => 'Photo',
    'nursery.list.bdate' => 'Birthday',
    'nursery.list.owner' => 'Owner:',
    'nursery.list.adress' => 'Adress',
    'nursery.list.phone' => 'Phone',
    'nursery.list.cellphone' => 'Cellphone',
    'nursery.list.email' => 'E-mail',
    'nursery.list.site' => 'Site',
    'nursery.list.about' => 'About',
    'nursery.list.nursery' => 'Nursery list',
    'main.title' => 'Home',
    'main.block.partners' => 'Our friends',
    'main.block.news' => 'News',
    'main.block.about_breed' => 'About breed',
    'main.dogs.take' => 'Take',
    'main.dogs.for_you' => 'your own',
    'main.dogs.tailed' => 'tailed',
    'main.dogs.zabava' => 'fun',
    'main.about_breed.description' => 'Miniature Schnauzer remains one of the most popular worldwide, primarily for its temperament and relatively small size. After all, it can be kept even in the smallest apartment. This is a very miniature breed with a weight of no more than 7 kg.',
    'header.link.main' => 'Home',
    'header.link.our_dogs' => 'Our dogs',
    'header.link.litters' => 'Litters',
    'header.link.advices' => 'Care tips',
    'header.link.exhibitions' => 'Exhibitions',
    'header.link.services' => 'Services',
    'header.link.gallery' => 'Gallery',
    'header.link.reviews' => 'Reviews',
    'header.link.login' => 'Login',
    'header.link.logout' => 'Logout',
    'services.list.services' => 'Service',
    'services.list.description' => 'Description',
    'services.list.price' => 'Price',
    'reviews.text.comment_author' => '<strong>%name%</strong> wrote:',
    'reviews.text.pay_attention' => 'Pay attention!',
    'reviews.text.comment_disclaimer' => '<p>All comments are thoroughly moderated. For publication are not allowed: </p><p> - comments of an advertising nature </p><p> - comments containing insults </p><p> - comments without specifying contact information</p>',
    'reviews.nursery.conact_us_via' => 'You can contact us via',
    'reviews.nursery.conact_us_via_phones' => 'phone:',
    'reviews.nursery.conact_us_via_email' => 'email:',
    'reviews.label.name' => 'Name',
    'reviews.label.email' => 'Email',
    'reviews.label.comment' => 'Comment',
    'reviews.label.phone' => 'Phone',
  ),
  'FOSUserBundle' => 
  array (
